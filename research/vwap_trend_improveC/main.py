...
# =====================================================================
# PROJEKT 3 — VYLEPŠOVACÍ FÁZE C: sweep prahu GAP gate (plateau check).
...
class VwapImproveB(QCAlgorithm):
    ...
    def initialize(self):
        ...
        self.sims = [
            Sim("base"),
            Sim("gap10", gap_min=0.10),
            Sim("gap15", gap_min=0.15),
            Sim("gap20", gap_min=0.20),
            Sim("gap25", gap_min=0.25),
            Sim("gap30", gap_min=0.30),
            Sim("gap40", gap_min=0.40),
            Sim("g20p60", gap_min=0.20, pt_max=0.60),
        ]
        self.cur_date = None
        self.cum_pv = 0.0
        self.cum_v = 0.0
